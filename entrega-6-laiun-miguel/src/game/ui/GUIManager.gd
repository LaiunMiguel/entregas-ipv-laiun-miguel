...
@onready var stamina_progress: ProgressBar = $StatsContainer/StaminaProgress
@onready var mana_progress: ProgressBar = $StatsContainer/ManaProgress

@onready var fading_elements: Array = [hp_progress_1, stamina_progress, mana_progress]
...
func _on_stamina_changed(sta: int, sta_max: int):
	stamina_progress.max_value = sta_max
	stamina_progress.value = sta
	_animate_fade()
